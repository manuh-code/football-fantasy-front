  ...
  <div class="min-h-screen bg-gray-50 dark:bg-gray-950 pb-24 md:pb-8">
    ...
    <div v-if="returnPath" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 mb-2">
      <button
        ...
        class="inline-flex items-center gap-1.5 px-3 py-1.5 text-footnote font-medium text-gray-600 dark:text-gray-400 rounded-lg active:bg-gray-100 dark:active:bg-gray-800 transition-colors"
      >
