<template>
    <div class="animate-page-enter grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
                ...
                <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400">Find and join exciting fantasy football leagues</p>
                        </div>
                    </div>
                </div>
                ...
                <form @submit.prevent="searchLeagues" class="p-6 space-y-5">
                    ...
                    <div>
                        <FormInput
                            v-model="searchQuery"
                            label="Search Fantasy Leagues"
                            placeholder="Search by league name or description..."
                            :error="searchError"
                            :disabled="isLoading || leagueType === 'all'"
                        ...
                        <div class="flex flex-col sm:flex-row gap-4">
                            ...
                            <label class="flex items-center">
                                <input
                                    ...
                                    :disabled="isLoading"
                                />
                                <span class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300 flex items-center">
        ...
        <div class="lg:col-span-1">
                ...
                <div class="p-6 space-y-4">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-600 dark:text-gray-400 mt-1">Browse all available leagues without filtering</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-600 dark:text-gray-400 mt-1">Open to everyone, join instantly</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-600 dark:text-gray-400 mt-1">Invitation only, request to join</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-600 dark:text-gray-400 mt-1">Use keywords to find specific leagues</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- Welcome Message -->
            <div v-if="!hasSearched" class="mt-6 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
...
const searchLeagues = async () => {
    ...
    try {
        ...
        const response = await catalogService.getFantasyLeaguesSearch(searchPayload)
...
const onJoinLeague = (league: FantasyLeaguesResponse) => {
    selectedLeague.value = league
    showJoinModal.value = true
}

const handleJoinLeague = async (joinData: { league: FantasyLeaguesResponse; message?: string }) => {
    try {
        isLoading.value = true
        const { league } = joinData

        // TODO: Implement actual join logic with catalogService
        // await catalogService.joinFantasyLeague({ leagueId: league.id, message })
        ...
        toast.error('Error', 'Failed to join the league. Please try again.')
    }
}
</script>
