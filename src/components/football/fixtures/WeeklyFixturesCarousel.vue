<template>
  <div class="w-full bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
    <!-- Header -->
    <div class="px-3 py-3 sm:px-4 sm:py-4 border-b border-gray-200 dark:border-gray-700">
    ...
    <div class="p-3 sm:p-4">
      ...
      <div
        ...
        class="text-center py-6 sm:py-8 text-gray-400 dark:text-gray-500"
      >
        <v-icon name="hi-calendar" class="w-8 h-8 sm:w-10 sm:h-10 mx-auto mb-2 text-gray-300 dark:text-gray-600" />
          ...
          >
            ...
            >
              <div 
                ...
                :class="isMobile ? 'flex justify-center' : 'grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3'"
              >
                <div
                ...
                >
                  ...
                  <div class="text-center" :class="isMobile ? 'mb-4' : 'mb-3'">
                    ...
                    <div 
                      :class="isMobile ? 'text-base font-semibold' : 'text-xs font-medium'"
                  ...
                  <div class="flex items-center justify-between gap-2">
                    ...
                    <!-- Score Section -->
                    <div class="flex flex-col items-center" :class="isMobile ? 'min-w-[70px]' : 'min-w-[50px]'">
                      <div 
                        :class="isMobile ? 'text-2xl mb-2' : 'text-lg sm:text-xl mb-1'"
                      ...
                      >
                        ...
                        <template v-else>
                          <span class="text-gray-400" :class="isMobile ? 'text-lg' : 'text-sm'">VS</span>
                        </template>
                      </div>
                      <span
                        :class="[
                          getStateClass(fixture.state),
                          isMobile ? 'text-sm px-2 py-1' : 'text-xs px-1.5 py-0.5',
...
const hasScores = (fixture: FootballFixtureResponse): boolean => {
  ...
  return fixture.participants.length >= 2 &&
...
const isMatchInProgress = (fixture: FootballFixtureResponse): boolean => {
  ...
  return stateName.includes('live') || 
...
const getTeamResultClass = (fixture: FootballFixtureResponse, teamIndex: number): string => {
  ...
  const teamWon = (isHomeTeam && homeScore > awayScore) || (!isHomeTeam && awayScore > homeScore)
...
const getStateClass = (state: FootballStateResponse | null): string => {
  ...
  } else if (stateName.includes('live') || stateName.includes('ht') || stateName.includes('in play')) {
    return 'bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-300'
  } else if (stateName.includes('postponed') || stateName.includes('cancelled')) {
