            ...
            <thead class="bg-gray-50 dark:bg-gray-700">
                <tr>
                    ...
                    <th
                        ...
                        <div class="flex items-center justify-between">
                            <span>{{ $t('football.player.table.position') }}</span>
                    ...
                    <th
                        :class="[
                            'px-6 py-3 text-left text-xs font-medium uppercase tracking-wider cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors select-none',
                            sortBy === 'country' ? 'text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-900/20' : 'text-gray-500 dark:text-gray-300'
                        ]"
                        @click="$emit('sort', 'country')">
                        <div class="flex items-center justify-between">
                            <span>{{ $t('football.player.table.country') }}</span>
