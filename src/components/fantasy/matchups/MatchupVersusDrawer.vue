...
<template>
  <BottomSheet :is-visible="isOpen" size="xl" role="dialog" @close="emit('close')">
    <!-- Custom header: score summary with both managers -->
    <template #header>
      <div class="relative">
        <button
          @click="emit('close')"
          class="absolute -top-1 right-0 w-8 h-8 rounded-full flex items-center justify-center text-gray-400 dark:text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-800 active:scale-90 transition-all"
