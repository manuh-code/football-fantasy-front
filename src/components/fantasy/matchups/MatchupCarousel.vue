        ...
        <div class="px-4 py-4 flex items-center gap-3">
          ...
          <div class="flex items-center gap-2.5 flex-1 min-w-0">
            ...
            >
              ...
              <span v-else class="text-[11px] font-bold text-gray-400">{{ matchup.home.team.team_name.substring(0, 2).toUpperCase() }}</span>
            </div>
            <div class="min-w-0">
              <p class="text-[13px] font-semibold text-gray-800 dark:text-gray-200 truncate leading-tight">
          ...
          <div class="flex items-center gap-1.5 shrink-0 px-3 py-2 rounded-xl bg-gray-50 dark:bg-gray-700/50">
            <span class="text-[18px] font-extrabold tabular-nums leading-none text-gray-900 dark:text-white">{{ matchup.home.score }}</span>
            <span class="text-[12px] text-gray-300 dark:text-gray-600">–</span>
            <span class="text-[18px] font-extrabold tabular-nums leading-none text-gray-900 dark:text-white">{{ matchup.away.score }}</span>
          </div>
          ...
          <div class="flex items-center gap-2.5 flex-1 min-w-0 justify-end">
            ...
            >
              ...
              <span v-else class="text-[11px] font-bold text-gray-400">{{ matchup.away.team.team_name.substring(0, 2).toUpperCase() }}</span>
            </div>
          </div>
